...
public class CreatePTNoteElectronic extends WebDriverCommonLib{
	
	@FindBy(xpath="//ul/li/a[contains(text(),'Others')]")
	private WebElement tabClick;

	@FindBy(xpath="//ul/li/a[contains(text(),'PT, Therapy Note')]")
	private WebElement childTabClick;
	
	@FindBy(id="PatientSearchKey")
	private WebElement patSelect;
	
	//@FindBy(xpath="//ul/li/strong[contains(text(),'Carl')]")
	...
	public void createTheraphy(String patName, String physName, String clinicianName, String order, String signDate, String effctDate){
		tabClick.click();
		childTabClick.click();
