...
public class UploadEditableElectronic extends WebDriverCommonLib{
	...
	public void uploadEditable(String patName, String physName, String clinicianName, String filePath, String signDate, String effDate){
		String url = AgencyTest.driver.getCurrentUrl();
		System.out.println(url);
		String url1 = url.replace("http://","");
		String[] parts = url1.split("/");
		String new_url = "http://qa.doctoralliance.net/"+parts[1]+"/Documents/CreateSignable?docType=OTHER_EDITABLE";
